...
async function connectToWA() {
  console.log("Connecting lakshan-MD 🧬...");
  ...
  danuwa.ev.on('connection.update', async (update) => {
    ...
    if (connection === 'close') {
      ...
      console.log('✅ lakshan-MD connected to WhatsApp');

      const up = `DANUWA-MD connected ✅\n\nPREFIX: ${prefix}`;
      await danuwa.sendMessage(ownerNumber[0] + "@s.whatsapp.net", {
        image: { url: `https://github.com/Vishath456/Lakshanmd/commit/cd67ef3e3b50e05d297b63fd77812ed95d3ba4bc` },
        caption: up
      });
...
app.get("/", (req, res) => {
  res.send("Hey, LAKSHAN-MD started✅");
});
